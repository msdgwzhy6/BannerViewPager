...
| 方法名 | 方法描述 | 说明 |
|--|--|--|
| BannerViewPager<T, VH> startLoop() |开启自动轮播  |  |
| BannerViewPager<T, VH> stopLoop() | 停止自动轮播 |  |
...
| BannerViewPager<T, VH> setIndicatorGravity(int gravity) | 指示器位置（0 Center、1 Start、2 End） |默认值0 Center |
